...
struct ContentView: View {
    ...
    private func checkForWinner() {
        ...
        checkLine(a: 0, b: 3, c: 6) // 1st column
        checkLine(a: 1, b: 4, c: 7) // 2nd column
        checkLine(a: 2, b: 5, c: 8) // 3rd column
        checkLine(a: 0, b: 4, c: 8) // top left to right diagonal
        checkLine(a: 6, b: 4, c: 2) // top right to left diagonal
    }
